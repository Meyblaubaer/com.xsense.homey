...
class XSenseAPI {
  ...
  _handleEventMessage(topic, data) {
    ...
    const merged = {
      ...
      alarmStatus: data.alarmStatus !== undefined ? data.alarmStatus : existing.alarmStatus,
      coPpm: data.coPpm !== undefined ? data.coPpm : existing.coPpm,
      ...
      batInfo: data.batInfo !== undefined ? data.batInfo : existing.batInfo
    };
